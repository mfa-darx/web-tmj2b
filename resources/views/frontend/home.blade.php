            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="categories__item categories__large__item set-bg"
                        data-setbg="{{ asset('me') }}/img/gitar.png">
                        <div class="categories__text">
                            <p style="font-size: 30px;font-weight: bold;color: white;">Temukan Alat Musik Favoritemu disini!</p>
                            <a style="font-size: 15px;color: white;" href="#">Jelajahi Sekarang</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
